...
shipped in [PR #117](https://github.com/markpasternak/canvas-drop/pull/117) and was deployed on 8 September 2026 ([issue #116](https://github.com/markpasternak/canvas-drop/issues/116)).
...
MCP surface to 49. The production rollout adapted the affected canvases and
migrated authored comments and attachments after a backup and rehearsal.
See the [rollout verification](solutions/2026-09-08-runtime-permissions-rollout.md)
and the [upgrade guide](site/self-hosting/runtime-upgrade.md).
