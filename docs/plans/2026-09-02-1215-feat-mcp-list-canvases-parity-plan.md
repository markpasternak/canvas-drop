...
- R9. **Superseded by the approved follow-up in `2026-09-02-1340-feat-share-permissions-ux-clone-parity-plan.md`:** direct- and team-granted viewers now have clone parity. Both grant shapes remain unable to clone archived, disabled, unpublished, expired, or password-gated sources.
