...
- [ ] **U2 — Resume work from details.** Put Open, Edit draft and Share together, with publication-aware actions and compact version/activity details. Keep duplicate and full management reachable. Verify draft, published, unpublished, archived and disabled states plus drawer keyboard behavior.
