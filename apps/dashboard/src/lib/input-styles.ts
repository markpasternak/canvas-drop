...
export const inputControlBase =
  "w-full rounded-md border border-border-strong bg-surface-raised py-2 text-base text-fg sm:text-sm " +
...
/**
 * Shared list/filter search field: a 36px control with room for the magnifier.
 * Mobile text stays at 16px; desktop keeps the denser 14px treatment.
 */
export const searchInput =
  "h-9 w-full rounded-lg border border-border bg-surface pr-3 pl-9 text-base text-fg sm:text-sm " +
