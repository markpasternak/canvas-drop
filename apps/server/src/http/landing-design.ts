...
@media (max-width: 420px) { .tour-controls { flex-wrap: wrap; } .dots { order: 3; width: 100%; flex-wrap: nowrap; gap: 0; } .dot { flex: 1; width: auto; min-width: 0; } .prims { grid-template-columns: 1fr; } .foot-links { gap: 1rem; flex-wrap: wrap; } }
