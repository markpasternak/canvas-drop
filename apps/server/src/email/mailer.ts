 ...
 * auth-delegated sign-in and access email flows. Four drivers: `mailgun` (HTTP
 ...
 * so the access flow surfaces it without crashing the request.
 */
...
export interface Mailer {
  ...
  /**
   * Whether sign-in/access flows can actually deliver email. True for
