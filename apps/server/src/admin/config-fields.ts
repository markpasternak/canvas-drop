...
export const CONFIG_FIELDS: readonly ConfigField[] = [
  ...
  },
  {
    ...
    help: "Email an existing user on a deliberate one-off 'invite to this canvas' action. No effect unless the master switch above is on and an email driver is configured.",
    type: "boolean",
    secret: false,
    editable: true,
