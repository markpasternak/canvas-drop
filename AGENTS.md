...
- **Static-first.** Canvases are static files; no build step and no canvas-supplied server-side code. Backend capability only via the six fixed primitives (KV, files, AI, identity, realtime, admin-granted outbound Connections).
