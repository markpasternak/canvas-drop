...
const pgTables = {
  ...
  emailTemplates: pg.emailTemplates,
  ...
  connectionProfiles: pg.connectionProfiles,
  canvasConnections: pg.canvasConnections,
  ...
  files: pg.files,
  aiUsage: pg.aiUsage,
  authoringUsage: pg.authoringUsage,
...
const sqliteTables = {
  ...
  emailTemplates: sq.emailTemplates,
  ...
  connectionProfiles: sq.connectionProfiles,
  canvasConnections: sq.canvasConnections,
  invitations: sq.invitations,
  ...
  files: sq.files,
  aiUsage: sq.aiUsage,
  authoringUsage: sq.authoringUsage,
